    ...
    <div class="headder-top d-md-flex" style="margin-top:-10px;background-color:#000000;">
      ...
      <nav class="mx-md-auto" >
        ...
        <ul class="menu mt-2">
          ...
          <li class="active">
            <a href="getimage.php">Test Cardamom</a>
            </li>

            <li class="active">
            <a href="viewproduct.php">Update Stock</a>
            </li>
          ...
          <li class="active">
          <a href="viewprofile.php"><img src="../Customer/img/avathar.png" alt="Avatar" class="avatar"></a>
