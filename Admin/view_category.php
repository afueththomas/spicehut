...
<body>
<form action="reg_category.php" method="post">
  ...
  <h2 style="text-align: center;margin-top: 6%;font-family: fantasy;">CATEGORY DETAILS</h2>
...
$sql=mysqli_query($con,"SELECT * FROM tbl_category");
   while($display=mysqli_fetch_array($sql))
   {
	...
	echo "<td><a style='color:#090' href='edit_category.php?c_id=".$display['c_id']."'>Edit</a> </td>";
	echo "<td><a style='color:#090' href='delete_category.php?c_id=".$display['c_id']."'>Delete</a> </td>";
	echo "</tr>";
